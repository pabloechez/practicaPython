...
#router.register(prefix=r'blogs', viewset=UserViewSet, base_name='user')
...
urlpatterns = [
    ...
    path('blog/nuevo', PostFormView.as_view(), name='post-create'),
    ...
    #API URLs
    #path('api/v1/blogs',  include(router.urls)),
